...
LIVE_SOURCES = [
    ...
    LiveSource(
        ...
        ["EPA"],
        SourceType.ENFORCEMENT,
        "https://yosemite.epa.gov/oarm/alj/alj_web_docket.nsf//All%20Dockets%20by%20Statute?SearchView&Query=%22C.%20F.%20R.%22&SearchMax=0&SearchWV=TRUE",
        max_links=500,
        use_pdf=True,
    ...
    LiveSource(
        ...
        ["EPA"],
        SourceType.ENFORCEMENT,
        "https://yosemite.epa.gov/oarm/alj/alj_web_docket.nsf//All%20Dockets%20by%20Statute?SearchView&Query=%22C.F.R.%22&SearchMax=0&SearchWV=TRUE",
        max_links=500,
        use_pdf=True,
        link_regex=r"OpenDocument",
        link_selector="a[href]",
    ...
    LiveSource(
        ...
        ["EPA"],
        SourceType.ENFORCEMENT,
        "https://yosemite.epa.gov/oarm/alj/alj_web_docket.nsf//All%20Dockets%20by%20Statute?SearchView&Query=%22CFR%22&SearchMax=0&SearchWV=TRUE",
        max_links=500,
        use_pdf=True,
        link_regex=r"OpenDocument",
        link_selector="a[href]",
